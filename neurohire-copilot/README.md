# NeuroHire Copilot Setup & Development Guide

This directory contains the source code for the **NeuroHire Copilot** system.
...
5. Select the `neurohire-copilot/extension/.output/chrome-mv3` folder.
